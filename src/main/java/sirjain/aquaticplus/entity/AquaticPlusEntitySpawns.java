...
public class AquaticPlusEntitySpawns {
	...
	public static void initLocations() {
		...
		BiomeModifications.addSpawn(BiomeSelectors.includeByKey(BiomeKeys.OCEAN, BiomeKeys.COLD_OCEAN, BiomeKeys.LUKEWARM_OCEAN, BiomeKeys.DEEP_OCEAN, BiomeKeys.DEEP_COLD_OCEAN, BiomeKeys.DEEP_LUKEWARM_OCEAN), AQPSpawnGroup.AQUATIC_PLUS, AquaticPlusEntities.MAXILLA_MORTIS_ENTITY, 10, 1, 1);
