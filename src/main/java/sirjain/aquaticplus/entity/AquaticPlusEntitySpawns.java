...
public class AquaticPlusEntitySpawns {
	...
	public static void initLocations() {
		BiomeModifications.addSpawn(BiomeSelectors.includeByKey(BiomeKeys.RIVER, BiomeKeys.WARM_OCEAN, BiomeKeys.DEEP_LUKEWARM_OCEAN, BiomeKeys.DEEP_OCEAN, BiomeKeys.FROZEN_RIVER, BiomeKeys.OCEAN, BiomeKeys.SWAMP, BiomeKeys.MANGROVE_SWAMP), AQPSpawnGroup.AQUATIC_PLUS, AquaticPlusEntities.SARDINE_ENTITY, 90, 6, 10);
		...
		BiomeModifications.addSpawn(BiomeSelectors.includeByKey(BiomeKeys.RIVER, BiomeKeys.WARM_OCEAN, BiomeKeys.DEEP_LUKEWARM_OCEAN, BiomeKeys.DEEP_OCEAN, BiomeKeys.FROZEN_RIVER, BiomeKeys.OCEAN, BiomeKeys.SWAMP, BiomeKeys.MANGROVE_SWAMP), AQPSpawnGroup.AQUATIC_PLUS, AquaticPlusEntities.HALIBUT_ENTITY, 78, 5, 8);
		BiomeModifications.addSpawn(BiomeSelectors.includeByKey(BiomeKeys.OCEAN, BiomeKeys.DEEP_OCEAN, BiomeKeys.WARM_OCEAN, BiomeKeys.COLD_OCEAN, BiomeKeys.RIVER, BiomeKeys.DEEP_LUKEWARM_OCEAN), AQPSpawnGroup.AQUATIC_PLUS, AquaticPlusEntities.BLUEFIN_TUNA_ENTITY, 75, 4, 7);
		...
		BiomeModifications.addSpawn(BiomeSelectors.includeByKey(BiomeKeys.RIVER, BiomeKeys.WARM_OCEAN, BiomeKeys.DEEP_LUKEWARM_OCEAN, BiomeKeys.DEEP_OCEAN, BiomeKeys.FROZEN_RIVER, BiomeKeys.OCEAN), AQPSpawnGroup.AQUATIC_PLUS, AquaticPlusEntities.SEA_PEN_ENTITY, 90, 5, 8);

		BiomeModifications.addSpawn(BiomeSelectors.includeByKey(BiomeKeys.OCEAN, BiomeKeys.WARM_OCEAN), AQPSpawnGroup.AQUATIC_PLUS, AquaticPlusEntities.PARROTFISH_ENTITY, 68, 4, 6);
		...
		BiomeModifications.addSpawn(BiomeSelectors.includeByKey(BiomeKeys.DEEP_OCEAN, BiomeKeys.DEEP_FROZEN_OCEAN, BiomeKeys.DEEP_COLD_OCEAN, BiomeKeys.FROZEN_OCEAN, BiomeKeys.FROZEN_RIVER, BiomeKeys.COLD_OCEAN), AQPSpawnGroup.AQUATIC_PLUS, AquaticPlusEntities.NARWHAL_ENTITY, 62, 3, 6);
		...
		BiomeModifications.addSpawn(BiomeSelectors.includeByKey(BiomeKeys.RIVER, BiomeKeys.FROZEN_RIVER, BiomeKeys.OCEAN, BiomeKeys.WARM_OCEAN, BiomeKeys.LUKEWARM_OCEAN), AQPSpawnGroup.AQUATIC_PLUS, AquaticPlusEntities.NEON_CRAB_ENTITY, 55, 2, 4);
		...
		BiomeModifications.addSpawn(BiomeSelectors.includeByKey(BiomeKeys.COLD_OCEAN, BiomeKeys.DEEP_COLD_OCEAN, BiomeKeys.DEEP_OCEAN, BiomeKeys.DEEP_LUKEWARM_OCEAN), AQPSpawnGroup.AQUATIC_PLUS, AquaticPlusEntities.MYTHICAL_SEAHORSE_ENTITY, 58, 2, 4);
		BiomeModifications.addSpawn(BiomeSelectors.includeByKey(BiomeKeys.RIVER), AQPSpawnGroup.AQUATIC_PLUS, AquaticPlusEntities.MYTHICAL_SEAHORSE_ENTITY, 50, 2, 4);
		BiomeModifications.addSpawn(BiomeSelectors.includeByKey(BiomeKeys.WARM_OCEAN, BiomeKeys.DEEP_OCEAN, BiomeKeys.OCEAN, BiomeKeys.DEEP_COLD_OCEAN, BiomeKeys.COLD_OCEAN, BiomeKeys.LUKEWARM_OCEAN, BiomeKeys.DEEP_LUKEWARM_OCEAN), AQPSpawnGroup.AQUATIC_PLUS, AquaticPlusEntities.VOLAN_AURORA_ENTITY, 40, 2, 4);

		BiomeModifications.addSpawn(BiomeSelectors.includeByKey(BiomeKeys.OCEAN, BiomeKeys.COLD_OCEAN, BiomeKeys.LUKEWARM_OCEAN, BiomeKeys.DEEP_OCEAN, BiomeKeys.DEEP_COLD_OCEAN, BiomeKeys.DEEP_LUKEWARM_OCEAN), AQPSpawnGroup.AQUATIC_PLUS, AquaticPlusEntities.MAXILLA_MORTIS_ENTITY, 16, 1, 1);
		...
		BiomeModifications.addSpawn(BiomeSelectors.includeByKey(BiomeKeys.DEEP_FROZEN_OCEAN, BiomeKeys.FROZEN_OCEAN), AQPSpawnGroup.AQUATIC_PLUS, AquaticPlusEntities.FROSTED_SPLASHER_ENTITY, 56, 1, 3);
		BiomeModifications.addSpawn(BiomeSelectors.includeByKey(BiomeKeys.FROZEN_RIVER), AQPSpawnGroup.AQUATIC_PLUS, AquaticPlusEntities.FROSTED_SPLASHER_ENTITY, 48, 1, 2);
