...
public class LanternfishModel extends EntityModel<LanternfishEntity> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData cube_r3 = body_2.addChild("cube_r3", ModelPartBuilder.create().uv(0, 40).cuboid(-1.0F, -3.0F, -3.0F, 2.0F, 6.0F, 6.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -1.75F, 4.0F, -0.3491F, 0.0F, 0.0F));
	...
	public void render(MatrixStack matrices, VertexConsumer vertices, int light, int overlay, float red, float green, float blue, float alpha) {
		matrices.push();
		matrices.translate(0, 0.3f, 0.5f);
