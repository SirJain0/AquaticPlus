...
public class AquaticPlusItems {
	...
	public static void registerSpawnEggs() {
		...
		VOLAN_AURORA_SPAWN_EGG = registerSpawnEggItem("volan_aurora", AquaticPlusEntities.VOLAN_AURORA_ENTITY, 0x4d9fd8, 0xb3a6e8); // TODO: Make this have a custom texture to incorporate purple
