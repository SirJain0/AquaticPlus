...
public class AquaticPlusItems {
    ...
    public static void registerSpawnEggs() {
        ...
        PARROTFISH_SPAWN_EGG = registerSpawnEggItem("parrotfish_spawn_egg", AquaticPlusEntities.PARROTFISH_ENTITY, 0x55b3dd, 0x6bef9d, new Item.Settings()); // change colors
    }
