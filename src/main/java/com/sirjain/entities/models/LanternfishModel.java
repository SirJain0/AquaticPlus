...
public class LanternfishModel extends EntityModel<LanternfishEntity> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData body_2 = body.addChild("body_2", ModelPartBuilder.create().uv(0, 22).cuboid(-2.0F, -0.75F, 0.0F, 4.0F, 5.0F, 7.0F, new Dilation(0.0F))
			.uv(0, 28).cuboid(0.0F, -5.75F, 1.0F, 0.0F, 6.0F, 6.0F, new Dilation(0.0F))
			.uv(32, 7).cuboid(0.0F, 3.25F, 2.0F, 0.0F, 5.0F, 5.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, -2.4735F, 6.875F));
		ModelPartData body_3 = body_2.addChild("body_3", ModelPartBuilder.create().uv(14, 27).cuboid(-1.0F, -2.0F, 0.0F, 2.0F, 4.0F, 8.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 2.0F, 7.0F));
		...
		ModelPartData head = lanternfish.addChild("head", ModelPartBuilder.create().uv(0, 0).cuboid(-3.0F, -2.0F, -6.0F, 6.0F, 4.0F, 6.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, -7.5F, -13.25F));
		ModelPartData lower_jaw = head.addChild("lower_jaw", ModelPartBuilder.create().uv(26, 27).cuboid(-3.0F, 0.75F, -6.25F, 6.0F, 1.0F, 6.0F, new Dilation(0.3F)), ModelTransform.pivot(0.0F, 1.5F, 0.075F));
